...
const screens = {
  Home: <div><h2>Benvenuto!</h2><p>“Ogni piccolo passo verso il benessere conta.”</p></div>,
  Diario: <div><h2>Diario</h2><p>Registra i tuoi pasti, sintomi ed evacuazioni.</p></div>,
  Report: <div><h2>Report</h2><p>Qui troverai le tue analisi personali.</p></div>,
  Profilo: <div><h2>Profilo</h2><p>Gestisci i tuoi dati personali.</p></div>,
  Chat: <div><h2>Chat I.A.</h2><p>Parla con la tua guida personalizzata.</p></div>,
};
